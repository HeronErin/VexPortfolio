...
class Controller(Device):
	...
	buttonL1=ControllerButton(0,0);buttonL2=ControllerButton(0,0);buttonR1=ControllerButton(0,0);buttonR2=ControllerButton(0,0)
	buttonUp=ControllerButton(0,0) ; buttonDown=ControllerButton(0,0) ; buttonLeft=ControllerButton(0,0) ; buttonRight=ControllerButton(0,0) ; 
	buttonA=ControllerButton(0,0) ; buttonB=ControllerButton(0,0) ; buttonX=ControllerButton(0,0) ; buttonY=ControllerButton(0,0)
	axis1=ControllerAxis(0,0);axis2=ControllerAxis(0,0);axis3=ControllerAxis(0,0);axis4=ControllerAxis(0,0)
